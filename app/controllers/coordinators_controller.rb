class CoordinatorsController < AuthenticationController
  before_action :set_coordinator, only: [:show, :edit, :update, :destroy]
  
  # Only admins can see the coordinators stuff
  ...
  def destroy
    @coordinator.destroy
    respond_to do |format|
      format.html { redirect_to coordinators_url, notice: 'Coordinator was successfully deleted.' }
  ...
  private
    ...
    def coordinator_params
      params.require(:coordinator).permit(:HCName, :HCPhone, :HCEmail)
    end
end
